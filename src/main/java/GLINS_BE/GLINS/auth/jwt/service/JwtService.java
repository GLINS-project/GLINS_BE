package GLINS_BE.GLINS.auth.jwt.service;
...
//        else throw new AllGlinsException(ErrorCode.INVALID_TOKEN_LOGOUT, ErrorCode.INVALID_TOKEN_LOGOUT.getMessage());
    ...
    public ClientResponseDto.logout logout(){
        ...
        if (!this.isTokenValid(accessToken)) {
            throw new AllGlinsException(ErrorCode.INVALID_TOKEN, ErrorCode.INVALID_TOKEN.getMessage());
        }
        ...
        return ClientResponseDto.logout.builder()
                .message("로그아웃 성공")
                .build();
    }
