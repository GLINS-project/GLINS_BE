...
import GLINS_BE.GLINS.auth.oauth2.handler.OAuth2LoginFailureHandler;
import GLINS_BE.GLINS.auth.oauth2.handler.OAuth2LoginSuccessHandler;
import GLINS_BE.GLINS.auth.oauth2.service.CustomOAuth2UserService;
...
//        인증, 인가 문제 발생 시 handler
    ...
    public Filter jwtAuthenticationProcessingFilter() {
        JwtAuthenticationProcessingFilter jwtAuthenticationFilter
                = new JwtAuthenticationProcessingFilter(jwtService, clientRepository, redisTemplate);
